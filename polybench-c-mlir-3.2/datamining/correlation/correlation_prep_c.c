...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "datamining/correlation/correlation.c" 2
...
# 9 "datamining/correlation/correlation.c" 2
...
# 10 "datamining/correlation/correlation.c" 2
...
extern char *stpncpy(char *__restrict __dest, const char *__restrict __src,
                     size_t __n) __attribute__((__nothrow__))
__attribute__((__nonnull__(1, 2)));
# 11 "datamining/correlation/correlation.c" 2
...
# 12 "datamining/correlation/correlation.c" 2
...
# 15 "datamining/correlation/correlation.c" 2

# 1 "datamining/correlation/correlation.h" 1
# 19 "datamining/correlation/correlation.c" 2
...
extern void kernel_correlation(int m, int n, double float_n,
                               double data[1000 + 0][1000 + 0],
...
int main(int argc, char **argv) {
  ...
  double float_n;
  double (*data)[1000 + 0][1000 + 0];
  data = (double (*)[1000 + 0][1000 + 0])
      polybench_alloc_data((1000 + 0) * (1000 + 0), sizeof(double));
  ;
  double (*symmat)[1000 + 0][1000 + 0];
  symmat = (double (*)[1000 + 0][1000 + 0])
      polybench_alloc_data((1000 + 0) * (1000 + 0), sizeof(double));
  ;
  double (*mean)[1000 + 0];
  ...
  stddev =
      (double (*)[1000 + 0]) polybench_alloc_data(1000 + 0, sizeof(double));
  ;
