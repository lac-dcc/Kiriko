...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./linear-algebra/kernels/cholesky/cholesky.c" 2
...
static void init_array(int n, double p[1024 + 0],
...
static void print_array(int n, double A[1024 + 0][1024 + 0])
...
extern void kernel_cholesky(int n, double p[1024 + 0],
                            double A[1024 + 0][1024 + 0]);
...
int main(int argc, char **argv) {
  ...
  ;
  double (*p)[1024 + 0];
  p = (double (*)[1024 + 0]) polybench_alloc_data(1024 + 0, sizeof(double));
  ;
