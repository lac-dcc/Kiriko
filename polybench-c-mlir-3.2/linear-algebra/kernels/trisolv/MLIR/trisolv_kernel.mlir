...
module {
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<4000x4000xf64>, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>) {
    ...
    affine.for %arg4 = 0 to %0 {
      ...
      affine.for %arg5 = 0 to #map(%arg4) {
        %5 = affine.load %arg2[%arg4] : memref<4000xf64>
        %6 = affine.load %arg1[%arg4, %arg5] : memref<4000x4000xf64>
        %7 = affine.load %arg2[%arg5] : memref<4000xf64>
