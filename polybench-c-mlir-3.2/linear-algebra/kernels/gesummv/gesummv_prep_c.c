...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./linear-algebra/kernels/gesummv/gesummv.c" 2
...
static void init_array(int n, double *alpha, double *beta,
                       ...
                       double B[4000 + 0][4000 + 0], double x[4000 + 0]) {
  int i, j;
...
extern void kernel_gesummv(int n, double alpha, double beta,
                           double A[4000 + 0][4000 + 0],
                           double B[4000 + 0][4000 + 0], double tmp[4000 + 0],
                           double x[4000 + 0], double y[4000 + 0]);
