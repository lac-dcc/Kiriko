...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./linear-algebra/kernels/syr2k/syr2k.c" 2
...
static void init_array(int ni, int nj, double *alpha, double *beta,
...
extern void kernel_syr2k(long n, long k, double alpha, double beta,
...
int main(int argc, char **argv) {
  ...
  kernel_syr2k(ni, nj, alpha, beta, *C, *C, 0, ni, ni, ni, 1, *A, *A, 0, ni, nj, nj,
               1, *B, *B, 0, ni, nj, nj, 1);
