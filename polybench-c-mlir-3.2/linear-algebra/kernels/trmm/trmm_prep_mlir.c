...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./linear-algebra/kernels/trmm/trmm.c" 2
...
static void init_array(int ni, double *alpha, double A[1024 + 0][1024 + 0],
...
static void print_array(int ni, double B[1024 + 0][1024 + 0]) {
  int i, j;
