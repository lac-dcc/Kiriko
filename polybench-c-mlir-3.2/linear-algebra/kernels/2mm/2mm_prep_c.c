...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./linear-algebra/kernels/2mm/2mm.c" 2
...
static void init_array(int ni, int nj, int nk, int nl, double *alpha,
                       double *beta, double A[1024 + 0][1024 + 0],
...
extern void kernel_2mm(int ni, int nj, int nk, int nl, double alpha,
