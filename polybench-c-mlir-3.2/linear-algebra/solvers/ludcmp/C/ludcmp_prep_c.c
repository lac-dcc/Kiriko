...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "linear-algebra/solvers/ludcmp/ludcmp.c" 2
...
static void init_array(int n, double A[1024 + 1 + 0][1024 + 1 + 0],
...
static void print_array(int n, double x[1024 + 1 + 0])
...
extern void kernel_ludcmp(int n, double A[1024 + 1 + 0][1024 + 1 + 0],
                          double b[1024 + 1 + 0], double x[1024 + 1 + 0],
                          double y[1024 + 1 + 0]);
...
int main(int argc, char **argv) {
  ...
  A = (double (*)[1024 + 1 + 0][1024 + 1 + 0])
      polybench_alloc_data((1024 + 1 + 0) * (1024 + 1 + 0), sizeof(double));
  ;
  double (*b)[1024 + 1 + 0];
  b = (double (*)[1024 + 1 + 0])
      polybench_alloc_data(1024 + 1 + 0, sizeof(double));
  ;
  double (*x)[1024 + 1 + 0];
  x = (double (*)[1024 + 1 + 0])
      polybench_alloc_data(1024 + 1 + 0, sizeof(double));
