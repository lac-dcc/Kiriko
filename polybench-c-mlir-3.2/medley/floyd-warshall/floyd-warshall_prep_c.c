...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "medley/floyd-warshall/floyd-warshall.c" 2
...
static void init_array(int n, double path[1024 + 0][1024 + 0]) {
  int i, j;
...
static void print_array(int n, double path[1024 + 0][1024 + 0])
...
extern void kernel_floyd_warshall(int n, double path[1024 + 0][1024 + 0]);
