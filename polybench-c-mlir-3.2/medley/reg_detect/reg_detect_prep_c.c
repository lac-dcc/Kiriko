...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "medley/reg_detect/reg_detect.c" 2
...
static void init_array(int maxgrid, int sum_tang[6 + 0][6 + 0],
                       int mean[6 + 0][6 + 0], int path[6 + 0][6 + 0]) {
  int i, j;
...
static void print_array(int maxgrid, int path[6 + 0][6 + 0]) {
  int i, j;
...
extern void kernel_reg_detect(int niter, int maxgrid, int length,
...
int main(int argc, char **argv) {
  ...
  int (*sum_tang)[6 + 0][6 + 0];
  sum_tang = (int (*)[6 + 0][6 + 0])
      polybench_alloc_data((6 + 0) * (6 + 0), sizeof(int));
  ;
  int (*mean)[6 + 0][6 + 0];
  mean = (int (*)[6 + 0][6 + 0])
      polybench_alloc_data((6 + 0) * (6 + 0), sizeof(int));
  ...
  ;
  int (*diff)[6 + 0][6 + 0][64 + 0];
  diff = (int (*)[6 + 0][6 + 0][64 + 0])
      polybench_alloc_data((6 + 0) * (6 + 0) * (64 + 0), sizeof(int));
  ;
  int (*sum_diff)[6 + 0][6 + 0][64 + 0];
  sum_diff = (int (*)[6 + 0][6 + 0][64 + 0])
      polybench_alloc_data((6 + 0) * (6 + 0) * (64 + 0), sizeof(int));
  ;
  ...
  kernel_reg_detect(niter, maxgrid, length, *sum_tang, *mean, *path, *diff,
                    *sum_diff);
