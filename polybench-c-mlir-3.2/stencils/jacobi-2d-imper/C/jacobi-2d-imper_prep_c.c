...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "stencils/jacobi-2d-imper/jacobi-2d-imper.c" 2
...
static void init_array(int n, double A[1000 + 0][1000 + 0],
...
extern void kernel_jacobi_2d_imper(int tsteps, int n,
