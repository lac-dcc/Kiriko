...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "stencils/fdtd-2d/fdtd-2d.c" 2
...
static void init_array(int tmax, int nx, int ny, double ex[1000 + 0][1000 + 0],
                       double ey[1000 + 0][1000 + 0],
                       double hz[1000 + 0][1000 + 0], double _fict_[50 + 0]) {
  int i, j;
...
static void print_array(int nx, int ny, double ex[1000 + 0][1000 + 0],
                        double ey[1000 + 0][1000 + 0],
...
extern void kernel_fdtd_2d(int tmax, int nx, int ny,
...
int main(int argc, char **argv) {
  ...
  double (*ex)[1000 + 0][1000 + 0];
  ex = (double (*)[1000 + 0][1000 + 0])
      polybench_alloc_data((1000 + 0) * (1000 + 0), sizeof(double));
  ;
  double (*ey)[1000 + 0][1000 + 0];
  ey = (double (*)[1000 + 0][1000 + 0])
      polybench_alloc_data((1000 + 0) * (1000 + 0), sizeof(double));
  ;
  double (*hz)[1000 + 0][1000 + 0];
  hz = (double (*)[1000 + 0][1000 + 0])
      polybench_alloc_data((1000 + 0) * (1000 + 0), sizeof(double));
  ;
  double (*_fict_)[50 + 0];
  _fict_ = (double (*)[50 + 0]) polybench_alloc_data(50 + 0, sizeof(double));
  ;
