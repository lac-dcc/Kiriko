...
static void init_array(int n, double X[1024 + 0][1024 + 0],
...
extern void kernel_adi(int tsteps, int n, double X[1024 + 0][1024 + 0],
                       double A[1024 + 0][1024 + 0],
                       double B[1024 + 0][1024 + 0]);
