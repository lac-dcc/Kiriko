...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "linear-algebra/solvers/gramschmidt/gramschmidt.c" 2
...
static void init_array(int ni, int nj, double A[512 + 0][512 + 0],
                       double R[512 + 0][512 + 0], double Q[512 + 0][512 + 0]) {
  int i, j;
...
static void print_array(int ni, int nj, double A[512 + 0][512 + 0],
...
extern void kernel_gramschmidt(int ni, int nj, double A[512 + 0][512 + 0],
                               double R[512 + 0][512 + 0],
                               double Q[512 + 0][512 + 0]);
...
int main(int argc, char **argv) {
  ...
  A = (double (*)[512 + 0][512 + 0])
      polybench_alloc_data((512 + 0) * (512 + 0), sizeof(double));
  ;
  double (*R)[512 + 0][512 + 0];
  R = (double (*)[512 + 0][512 + 0])
      polybench_alloc_data((512 + 0) * (512 + 0), sizeof(double));
  ;
  double (*Q)[512 + 0][512 + 0];
  Q = (double (*)[512 + 0][512 + 0])
      polybench_alloc_data((512 + 0) * (512 + 0), sizeof(double));
  ;
