...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "linear-algebra/solvers/dynprog/dynprog.c" 2
...
static void init_array(int length, int c[50 + 0][50 + 0],
                       int W[50 + 0][50 + 0]) {
  int i, j;
  for (i = 0; i < length; i++)
    for (j = 0; j < length; j++) {
...
extern void kernel_dynprog(int tsteps, int length, int c[50 + 0][50 + 0],
                           int W[50 + 0][50 + 0],
                           int sum_c[50 + 0][50 + 0][50 + 0], int *out);
...
int main(int argc, char **argv) {
  ...
  sum_c = (int (*)[50 + 0][50 + 0][50 + 0])
      polybench_alloc_data((50 + 0) * (50 + 0) * (50 + 0), sizeof(int));
  ;
  int (*c)[50 + 0][50 + 0];
  c = (int (*)[50 + 0][50 + 0])
      polybench_alloc_data((50 + 0) * (50 + 0), sizeof(int));
  ;
  int (*W)[50 + 0][50 + 0];
  W = (int (*)[50 + 0][50 + 0])
      polybench_alloc_data((50 + 0) * (50 + 0), sizeof(int));
  ...
  kernel_dynprog(tsteps, length, *c, *W, *sum_c, &out);
