...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "linear-algebra/solvers/durbin/durbin.c" 2
...
static void init_array(int n, double y[4000 + 0][4000 + 0],
...
static void print_array(int n, double out[4000 + 0])
...
static void kernel_durbin(int n, double y[4000 + 0][4000 + 0],
                          double sum[4000 + 0][4000 + 0],
                          double alpha[4000 + 0], double beta[4000 + 0],
                          double r[4000 + 0], double out[4000 + 0]) {
  int i, k;
...
int main(int argc, char **argv) {
  ...
  y = (double (*)[4000 + 0][4000 + 0])
      polybench_alloc_data((4000 + 0) * (4000 + 0), sizeof(double));
  ;
  double (*sum)[4000 + 0][4000 + 0];
  sum = (double (*)[4000 + 0][4000 + 0])
      polybench_alloc_data((4000 + 0) * (4000 + 0), sizeof(double));
  ;
  double (*alpha)[4000 + 0];
  alpha = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*beta)[4000 + 0];
  beta = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*r)[4000 + 0];
  r = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*out)[4000 + 0];
  out = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  ...
  kernel_durbin(n, *y, *sum, *alpha, *beta, *r, *out);
