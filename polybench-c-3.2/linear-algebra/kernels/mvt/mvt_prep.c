...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "linear-algebra/kernels/mvt/mvt.c" 2
...
static void init_array(int n, double x1[4000 + 0], double x2[4000 + 0],
...
static void print_array(int n, double x1[4000 + 0], double x2[4000 + 0])
...
static void kernel_mvt(int n, double x1[4000 + 0], double x2[4000 + 0],
                       double y_1[4000 + 0], double y_2[4000 + 0],
                       double A[4000 + 0][4000 + 0]) {
  int i, j;
...
int main(int argc, char **argv) {
  ...
  ;
  double (*x1)[4000 + 0];
  x1 = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*x2)[4000 + 0];
  x2 = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*y_1)[4000 + 0];
  y_1 = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*y_2)[4000 + 0];
  y_2 = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
