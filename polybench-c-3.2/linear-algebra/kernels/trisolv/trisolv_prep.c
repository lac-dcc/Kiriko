...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "linear-algebra/kernels/trisolv/trisolv.c" 2
...
static void init_array(int n, double A[4000 + 0][4000 + 0], double x[4000 + 0],
                       double c[4000 + 0]) {
  int i, j;
...
static void kernel_trisolv(int n, double A[4000 + 0][4000 + 0],
                           double x[4000 + 0], double c[4000 + 0]) {
  int i, j;
