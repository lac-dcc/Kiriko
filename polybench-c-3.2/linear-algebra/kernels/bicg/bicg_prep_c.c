...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./linear-algebra/kernels/bicg/bicg.c" 2
...
static void init_array(int nx, int ny, double A[4000 + 0][4000 + 0],
                       double r[4000 + 0], double p[4000 + 0]) {
  int i, j;
...
static void print_array(int nx, int ny, double s[4000 + 0], double q[4000 + 0])
...
static void kernel_bicg(int nx, int ny, double A[4000 + 0][4000 + 0],
                        double s[4000 + 0], double q[4000 + 0],
                        double p[4000 + 0], double r[4000 + 0]) {
  int i, j;
...
int main(int argc, char **argv) {
  ...
  A = (double (*)[4000 + 0][4000 + 0])
      polybench_alloc_data((4000 + 0) * (4000 + 0), sizeof(double));
  ;
  double (*s)[4000 + 0];
  s = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*q)[4000 + 0];
  q = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*p)[4000 + 0];
  p = (double (*)[4000 + 0]) polybench_alloc_data(4000 + 0, sizeof(double));
  ;
  double (*r)[4000 + 0];
