...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "stencils/fdtd-apml/fdtd-apml.c" 2
...
# 1 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 1 3 4
# 93 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 3 4
# 1 "/home/lucas/llvm-project/build/lib/clang/20/include/__stddef_size_t.h" 1 3 4
# 18 "/home/lucas/llvm-project/build/lib/clang/20/include/__stddef_size_t.h" 3 4
typedef long unsigned int size_t;
# 94 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 2 3 4
# 108 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 3 4
# 1 "/home/lucas/llvm-project/build/lib/clang/20/include/__stddef_null.h" 1 3 4
# 109 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 2 3 4
# 34 "/usr/include/stdio.h" 2 3 4

# 1 "/home/lucas/llvm-project/build/lib/clang/20/include/stdarg.h" 1 3 4
# 51 "/home/lucas/llvm-project/build/lib/clang/20/include/stdarg.h" 3 4
# 1 "/home/lucas/llvm-project/build/lib/clang/20/include/__stdarg___gnuc_va_list.h" 1 3 4
# 12 "/home/lucas/llvm-project/build/lib/clang/20/include/__stdarg___gnuc_va_list.h" 3 4
typedef __builtin_va_list __gnuc_va_list;
# 52 "/home/lucas/llvm-project/build/lib/clang/20/include/stdarg.h" 2 3 4
...
extern int fchownat(int __fd, const char *__file, __uid_t __owner,
                    __gid_t __group, int __flag) __attribute__((__nothrow__))
...
extern char *getwd(char *__buf) __attribute__((__nothrow__))
...
extern int linkat(int __fromfd, const char *__from, int __tofd,
                  const char *__to, int __flags) __attribute__((__nothrow__))
...
extern int ffsl(long int __l) __attribute__((__nothrow__))
__attribute__((__const__));
__extension__ extern int ffsll(long long int __ll) __attribute__((__nothrow__))
__attribute__((__const__));
...
__attribute__((__const__));
extern double __copysign(double __x, double __y) __attribute__((__nothrow__))
__attribute__((__const__));

extern double nan(const char *__tagb) __attribute__((__nothrow__));
extern double __nan(const char *__tagb) __attribute__((__nothrow__));
...
__attribute__((__const__));
extern float __copysignf(float __x, float __y) __attribute__((__nothrow__))
__attribute__((__const__));

extern float nanf(const char *__tagb) __attribute__((__nothrow__));
extern float __nanf(const char *__tagb) __attribute__((__nothrow__));
# 213 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
...
__attribute__((__const__));
extern long double __ceill(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));

extern long double fabsl(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));
extern long double __fabsl(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));

extern long double floorl(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));
extern long double __floorl(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));
...
extern long double __nanl(const char *__tagb) __attribute__((__nothrow__));
# 213 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
...
__attribute__((__const__));
extern long double __roundl(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));

extern long double truncl(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));
extern long double __truncl(long double __x) __attribute__((__nothrow__))
__attribute__((__const__));
...
# 1 "/home/lucas/llvm-project/build/lib/clang/20/include/__stddef_size_t.h" 1 3 4
# 94 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 2 3 4
# 103 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 3 4
# 1 "/home/lucas/llvm-project/build/lib/clang/20/include/__stddef_wchar_t.h" 1 3 4
# 24 "/home/lucas/llvm-project/build/lib/clang/20/include/__stddef_wchar_t.h" 3 4
typedef int wchar_t;
# 104 "/home/lucas/llvm-project/build/lib/clang/20/include/stddef.h" 2 3 4
...
extern long int a64l(const char *__s) __attribute__((__nothrow__))
__attribute__((__pure__)) __attribute__((__nonnull__(1)));
...
static void init_array(int cz, int cxm, int cym, double *mui, double *ch,
                       ...
                       double czm[256 + 1 + 0], double czp[256 + 1 + 0],
                       double cxmh[256 + 1 + 0], double cxph[256 + 1 + 0],
...
static void print_array(int cz, int cxm, int cym,
...
int main(int argc, char **argv) {
  ...
  double ch;
  double (*Ax)[256 + 1 + 0][256 + 1 + 0];
  Ax = (double (*)[256 + 1 + 0][256 + 1 + 0])
      polybench_alloc_data((256 + 1 + 0) * (256 + 1 + 0), sizeof(double));
  ;
  double (*Ry)[256 + 1 + 0][256 + 1 + 0];
  Ry = (double (*)[256 + 1 + 0][256 + 1 + 0])
      polybench_alloc_data((256 + 1 + 0) * (256 + 1 + 0), sizeof(double));
  ;
  double (*clf)[256 + 1 + 0][256 + 1 + 0];
  clf = (double (*)[256 + 1 + 0][256 + 1 + 0])
      polybench_alloc_data((256 + 1 + 0) * (256 + 1 + 0), sizeof(double));
  ;
  double (*tmp)[256 + 1 + 0][256 + 1 + 0];
  tmp = (double (*)[256 + 1 + 0][256 + 1 + 0])
      polybench_alloc_data((256 + 1 + 0) * (256 + 1 + 0), sizeof(double));
  ;
  double (*Bza)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0];
  Bza = (double (*)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0])
      polybench_alloc_data((256 + 1 + 0) * (256 + 1 + 0) * (256 + 1 + 0),
                           sizeof(double));
  ;
  double (*Ex)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0];
  Ex = (double (*)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0]) polybench_alloc_data(
      (256 + 1 + 0) * (256 + 1 + 0) * (256 + 1 + 0), sizeof(double));
  ;
  double (*Ey)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0];
  Ey = (double (*)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0]) polybench_alloc_data(
      (256 + 1 + 0) * (256 + 1 + 0) * (256 + 1 + 0), sizeof(double));
  ;
  double (*Hz)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0];
  Hz = (double (*)[256 + 1 + 0][256 + 1 + 0][256 + 1 + 0]) polybench_alloc_data(
      (256 + 1 + 0) * (256 + 1 + 0) * (256 + 1 + 0), sizeof(double));
  ;
  double (*czm)[256 + 1 + 0];
  czm = (double (*)[256 + 1 + 0])
      polybench_alloc_data(256 + 1 + 0, sizeof(double));
  ;
  double (*czp)[256 + 1 + 0];
  czp = (double (*)[256 + 1 + 0])
      polybench_alloc_data(256 + 1 + 0, sizeof(double));
  ...
  init_array(cz, cxm, cym, &mui, &ch, *Ax, *Ry, *Ex, *Ey, *Hz, *czm, *czp,
             *cxmh, *cxph, *cymh, *cyph);

  polybench_timer_start();
  ;

  kernel_fdtd_apml(cz, cxm, cym, mui, ch, *Ax, *Ry, *clf, *tmp, *Bza, *Ex, *Ey,
